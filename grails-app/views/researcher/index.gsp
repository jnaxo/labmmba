...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-primary" id="tituloinfo">
            ...
            <div class="panel-body">
                <ul class="list-group" id="profile-info">
                    <li class="list-group-item" id="profile-name">Nombre: ${user.getName()}</li>
                    <li class="list-group-item">Cargo: ${researcher.getLab_job()}</li>
                    <li class="list-group-item">Área de investigación: ${researcher.getResearch_area().name}</li>
                </ul>
            </div>
        </div>
        <!-- Studies -->
        ...
        <div class="panel panel-primary" id="titulopartners">
            <div class="panel-heading">
                <h3 class="panel-title">Colegas</h3>
            </div>
            <div class="panel-body">
